...
import DirectLoginForm from '@/components/login/DirectLoginForm.jsx';
import useAutoRedirect from '@/hooks/useAutoRedirect.js';
  ...
  return (
    <div>
      ...
      <div className="fixed max-w-[425px] w-full top-[60px] flex flex-col items-center justify-center gap-8 p-4">
        <p className="w-full text-black text-2xl font-bold">
          EasyPlace와 함께
          <br />
          쉽게 갈 수 있는 장소로 바로!
        </p>
        ...
        <div className="w-full flex items-center gap-4">
          <hr className="flex-grow border-t border-[color:theme('colors.gray100')]" />
          <span className="my-4 text-center text-[color:theme('colors.gray200')]">또는</span>
          <hr className="flex-grow border-t border-[color:theme('colors.gray100')]" />
        </div>
